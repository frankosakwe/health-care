...
import { ShieldAlert, Users, Database, LayoutDashboard, Search, Command, DollarSign } from 'lucide-react';
       ...
       <aside className="w-72 bg-[#050608] border-r border-slate-900 flex flex-col hidden xl:flex shrink-0 h-screen sticky top-0 z-50">
          <div className="p-8">
             ...
             <nav className="space-y-1.5">
                ...
                <SidebarItem to="/payments" icon={<DollarSign size={20} />} label="Payment Analytics" badge="NEW" />
